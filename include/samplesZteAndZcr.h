#ifndef SAMPLES_ZTE_AND_ZCR_H
#define SAMPLES_ZTE_AND_ZCR_H
...
typedef struct {
    const char* command;
    const SampleZteAndZcr* samples;
    unsigned int count;
} CommandSamplesZteAndZcr;

static const SampleZteAndZcr g_samples_down[] = {
...
static const SampleZteAndZcr g_samples_left[] = {
...
static const SampleZteAndZcr g_samples_off[] = {
...
static const SampleZteAndZcr g_samples_on[] = {
    ...
    {0.0022721535f, 0.034695413f},
    {0.036970012f, 0.14578933f},
};

static const SampleZteAndZcr g_samples_right[] = {
    ...
    {0.0023854363f, 0.036237732f},
    {0.035265453f, 0.2262276f},
    {0.0025131942f, 0.032017313f},
};

static const SampleZteAndZcr g_samples_start[] = {
...
static const SampleZteAndZcr g_samples_stop[] = {
    ...
    {0.044831563f, 0.28706849f},
};

static const SampleZteAndZcr g_samples_up[] = {
...
static const CommandSamplesZteAndZcr g_command_samples_zte_and_zcr[] = {
    {"down", g_samples_down, (unsigned int)(sizeof(g_samples_down) / sizeof(g_samples_down[0]))},
    {"left", g_samples_left, (unsigned int)(sizeof(g_samples_left) / sizeof(g_samples_left[0]))},
    {"off", g_samples_off, (unsigned int)(sizeof(g_samples_off) / sizeof(g_samples_off[0]))},
    {"on", g_samples_on, (unsigned int)(sizeof(g_samples_on) / sizeof(g_samples_on[0]))},
    {"right", g_samples_right, (unsigned int)(sizeof(g_samples_right) / sizeof(g_samples_right[0]))},
    {"start", g_samples_start, (unsigned int)(sizeof(g_samples_start) / sizeof(g_samples_start[0]))},
    {"stop", g_samples_stop, (unsigned int)(sizeof(g_samples_stop) / sizeof(g_samples_stop[0]))},
    {"up", g_samples_up, (unsigned int)(sizeof(g_samples_up) / sizeof(g_samples_up[0]))},
};
