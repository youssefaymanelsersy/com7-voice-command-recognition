...
PROCESSED_SIGNAL_TX_PORT = os.getenv("VOICE_PROCESSED_SIGNAL_TX_PORT", "")
PROCESSED_SIGNAL_TX_BAUDRATE = _env_int("VOICE_PROCESSED_SIGNAL_TX_BAUDRATE", 115200)
MODEL_FILE = os.getenv("VOICE_MODEL_FILE", "models/model.json")

QUIET_THRESHOLD = _env_int("VOICE_QUIET_THRESHOLD", 2500)
CLIPPING_THRESHOLD = _env_int("VOICE_CLIPPING_THRESHOLD", 32000)
